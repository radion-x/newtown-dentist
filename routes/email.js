...
Received on ${new Date().toLocaleString()}
        ` : `
New Inquiry from Elite Dentistry Website
...
Received on ${new Date().toLocaleString()}
        ...
        if (email) {
            const autoReplyData = {
                ...
                html: `
                    ...
                    <head>
                        <style>
                            body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
                            .container { max-width: 600px; margin: 0 auto; padding: 20px; }
                            .header { background: linear-gradient(135deg, #3D6B82, #5990AE); color: white; padding: 20px; text-align: center; }
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                <p>Hi ${name},</p>
                                <p>Thank you for your interest in Zoom teeth whitening. We've received your inquiry and our team will get back to you within 24 hours to discuss your treatment options.</p>
                                <p>In the meantime, if you have any urgent questions, please call us at <a href="tel:0283505840">(02) 8350 5840</a>.</p>
                                <p>Best regards,<br>The Elite Dentistry Team</p>
                            </div>
                            <div class="footer">
                ...
                `,
                text: `Hi ${name},\n\nThank you for your interest in Zoom teeth whitening. We've received your inquiry and our team will get back to you within 24 hours to discuss your treatment options.\n\nIf you have any urgent questions, please call us at (02) 8350 5840.\n\nBest regards,\nThe Elite Dentistry Team`
            };
